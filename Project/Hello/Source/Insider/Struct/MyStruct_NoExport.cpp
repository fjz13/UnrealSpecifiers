...
INSIDER_API UScriptStruct* Z_Construct_UScriptStruct_FMyStruct_NoExport(ETypeConstructPhase);
UPackage* Z_Construct_UPackage__Script_Insider(ETypeConstructPhase);
...
class UScriptStruct* FMyStruct_NoExport::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MyStruct_NoExport.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMyStruct_NoExport, Z_Construct_UPackage__Script_Insider(ETypeConstructPhase::Outer), TEXT("MyStruct_NoExport"));
	}
