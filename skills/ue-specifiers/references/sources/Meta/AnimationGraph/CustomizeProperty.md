---
title: "CustomizeProperty"
id: "meta.CustomizeProperty"
kind: "meta"
...
summary: "使用在FAnimNode的成员属性上，告诉编辑器不要为它生成默认Details面板控件，后续会在DetailsCustomization里自定义创建相应的编辑控件"
usage: "UPROPERTY"
---
...
- **Use when:** `CustomizeProperty` metadata 的 `UPROPERTY` 场景需要：使用在FAnimNode的成员属性上，告诉编辑器不要为它生成默认Details面板控件，后续会在DetailsCustomization里自定义创建相应的编辑控件。
