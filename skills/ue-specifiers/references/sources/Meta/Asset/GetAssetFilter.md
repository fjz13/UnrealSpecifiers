...
id: "meta.GetAssetFilter"
kind: "meta"
symbol: "GetAssetFilter"
category: "Asset"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "指定一个UFUNCTION来对UObject*属性的可选资源进行排除过滤"
usage: "UPROPERTY"
---
...
- **Use when:** `GetAssetFilter` metadata 的 `UPROPERTY` 场景需要：指定一个UFUNCTION来对UObject*属性的可选资源进行排除过滤。
- **Do not use when:** 目标声明不属于 `UPROPERTY`，或该展示/编辑/节点行为不是代码契约的一部分。
- **Requires:** 值应指向可调用的过滤函数，通常接收 `FAssetData`；该函数只参与编辑器资产 picker 过滤。
