...
id: "meta.BlueprintProtected"
kind: "meta"
symbol: "BlueprintProtected"
category: "Blueprint"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "指定该函数或属性只能在本类以及子类中被调用或读写，类似C++中的protected作用域限制。不可在别的蓝图类里访问"
...
- **Use when:** `BlueprintProtected` metadata 的 `UFUNCTION, UPROPERTY` 场景需要：指定该函数或属性只能在本类以及子类中被调用或读写，类似C++中的protected作用域限制。不可在别的蓝图类里访问。
...
- **引擎模块：** Blueprint
- **元数据类型：** bool
- **关联项：** [BlueprintPrivate](BlueprintPrivate.md), [AllowPrivateAccess](AllowPrivateAccess.md)
- **常用程度：** ★★★
...
UE5.8 function metadata；BlueprintGraph `BlueprintProtected`，仅本类和子类可访问。
