...
id: "meta.NeedsLatentFixup"
kind: "meta"
symbol: "NeedsLatentFixup"
category: "Blueprint"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "用在FLatentActionInfo::Linkage属性上，告诉蓝图VM生成跳转信息"
usage: "UPROPERTY"
---
...
- **Use when:** `NeedsLatentFixup` metadata 的 `UPROPERTY` 场景需要：用在FLatentActionInfo::Linkage属性上，告诉蓝图VM生成跳转信息。
...
UE5.8 property/function internal metadata；latent action manager/BlueprintGraph fixup 使用。
