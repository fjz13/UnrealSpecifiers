---
title: "UseComponentPicker"
id: "meta.UseComponentPicker"
kind: "meta"
...
summary: "用在ComponentReference属性上，使得选取器的列表里展示出Actor属下的Component以便选择"
usage: "UPROPERTY"
---
...
- **Use when:** `UseComponentPicker` metadata 的 `UPROPERTY` 场景需要：用在ComponentReference属性上，使得选取器的列表里展示出Actor属下的Component以便选择。
