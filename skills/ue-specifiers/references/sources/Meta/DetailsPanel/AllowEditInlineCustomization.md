---
title: "AllowEditInlineCustomization"
id: "meta.AllowEditInlineCustomization"
kind: "meta"
symbol: "AllowEditInlineCustomization"
category: "DetailsPanel"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "允许EditInline的对象属性可以自定义属性细节面板来编辑该对象内的数据"
usage: "UPROPERTY"
---
...
- **Use when:** `AllowEditInlineCustomization` metadata 的 `UPROPERTY` 场景需要：允许EditInline的对象属性可以自定义属性细节面板来编辑该对象内的数据。
...
UE5.8 property metadata；PropertyEditor DetailPropertyRow 读取它，为 instanced UObject property 启用 detail class customization。
