...
- **引擎模块：** DetailsPanel
- **元数据类型：** string="abc"
- **关联项：** [EditConditionHides](EditConditionHides.md), [InlineEditConditionToggle](InlineEditConditionToggle.md), [HideEditConditionToggle](HideEditConditionToggle.md)
- **常用程度：** ★★★★★
