...
- **Use when:** `ReapplyCondition` metadata 的 `UPROPERTY` 场景需要：// Properties that have a ReapplyCondition should be disabled behind the specified property when in reapply mode。
