---
title: "ValidEnumValues"
id: "meta.ValidEnumValues"
kind: "meta"
...
- **Use when:** `ValidEnumValues` metadata 的 `UPROPERTY` 场景需要：指定枚举属性值上可选的枚举值选项。
...
- **元数据类型：** strings="a，b，c"
- **限制类型：** 枚举属性值
- **关联项：** [InvalidEnumValues](InvalidEnumValues.md), [GetRestrictedEnumValues](GetRestrictedEnumValues.md), [EnumValueDisplayNameOverrides](EnumValueDisplayNameOverrides.md), [Enum](Enum.md)
- **常用程度：** ★★★
