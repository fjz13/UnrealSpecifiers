...
summary: "标明该属性其引用的资产属于哪一些AssetBundles"
usage: "UPROPERTY"
---
...
- **Use when:** `AssetBundles` metadata 的 `UPROPERTY` 场景需要：标明该属性其引用的资产属于哪一些AssetBundles。
...
- **关联项：** [IncludeAssetBundles](IncludeAssetBundles.md)
- **常用程度：** ★★★
