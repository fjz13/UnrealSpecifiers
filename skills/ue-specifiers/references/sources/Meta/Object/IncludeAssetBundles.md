---
title: "IncludeAssetBundles"
id: "meta.IncludeAssetBundles"
kind: "meta"
...
summary: "用于UPrimaryDataAsset的子对象属性，指定应该继续递归到该子对象里去探测AssetBundle数据"
usage: "UPROPERTY"
---
...
- **Use when:** `IncludeAssetBundles` metadata 的 `UPROPERTY` 场景需要：用于UPrimaryDataAsset的子对象属性，指定应该继续递归到该子对象里去探测AssetBundle数据。
...
- **关联项：** [AssetBundles](AssetBundles.md)
- **常用程度：** ★★
