...
id: "meta.ShowOnlyInnerProperties"
kind: "meta"
symbol: "ShowOnlyInnerProperties"
category: "Object"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "把结构属性的内部属性直接上提一个层级直接展示"
usage: "UPROPERTY"
---
...
- **Use when:** `ShowOnlyInnerProperties` metadata 的 `UPROPERTY` 场景需要：把结构属性的内部属性直接上提一个层级直接展示。
- **Do not use when:** 目标声明不属于 `UPROPERTY`，或该展示/编辑/节点行为不是代码契约的一部分。
- **Requires:** 目标应是结构体属性；该 metadata 只改变 Details Panel 展示层级，不改变数据布局或访问路径。
