---
title: "RigVMTypeAllowed"
id: "meta.RigVMTypeAllowed"
kind: "meta"
symbol: "RigVMTypeAllowed"
category: "RigVM"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "指定一个UENUM可以在FRigUnit的UEnum*属性中被选择"
usage: "UENUM"
---
...
- **Use when:** `RigVMTypeAllowed` metadata 的 `UENUM` 场景需要：指定一个UENUM可以在FRigUnit的UEnum*属性中被选择。
