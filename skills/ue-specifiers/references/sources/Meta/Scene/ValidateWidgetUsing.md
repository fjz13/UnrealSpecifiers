---
title: "ValidateWidgetUsing"
id: "meta.ValidateWidgetUsing"
kind: "meta"
...
- **Use when:** `ValidateWidgetUsing` metadata 的 `UPROPERTY` 场景需要：提供一个函数来验证当前属性值是否合法。
...
- **关联项：** [MakeEditWidget](MakeEditWidget.md)
- **常用程度：** ★★★
