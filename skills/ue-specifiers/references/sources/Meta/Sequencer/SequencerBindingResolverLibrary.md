---
title: "SequencerBindingResolverLibrary"
id: "meta.SequencerBindingResolverLibrary"
kind: "meta"
...
summary: "把具有SequencerBindingResolverLibrary标记的UBlueprintFunctionLibrary作为动态绑定的类"
usage: "UCLASS"
---
...
- **Use when:** `SequencerBindingResolverLibrary` metadata 的 `UCLASS` 场景需要：把具有SequencerBindingResolverLibrary标记的UBlueprintFunctionLibrary作为动态绑定的类。
