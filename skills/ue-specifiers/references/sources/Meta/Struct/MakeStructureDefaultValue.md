---
title: "MakeStructureDefaultValue"
id: "meta.MakeStructureDefaultValue"
kind: "meta"
...
- **Use when:** `MakeStructureDefaultValue` metadata 的 `UPROPERTY` 场景需要：存储BP中自定义结构里的属性的默认值。
