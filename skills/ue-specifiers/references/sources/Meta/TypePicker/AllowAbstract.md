---
title: "AllowAbstract"
id: "meta.AllowAbstract"
kind: "meta"
symbol: "AllowAbstract"
category: "TypePicker"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "用于类属性，指定是否接受抽象类"
usage: "UPARAM, UPROPERTY"
---
...
- **Use when:** `AllowAbstract` metadata 的 `UPARAM, UPROPERTY` 场景需要：用于类属性，指定是否接受抽象类。
- **Do not use when:** 目标声明不属于 `UPARAM, UPROPERTY`，或该展示/编辑/节点行为不是代码契约的一部分。
