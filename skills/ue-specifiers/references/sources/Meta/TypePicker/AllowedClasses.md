...
summary: "用在类或对象选择器上，指定选择的对象必须属于某一些类型基类"
usage: "UPROPERTY"
---
...
- **关联项：** [ExactClass](ExactClass.md), [DisallowedClasses](DisallowedClasses.md), [GetAllowedClasses](GetAllowedClasses.md), [GetDisallowedClasses](GetDisallowedClasses.md)
- **常用程度：** ★★★
