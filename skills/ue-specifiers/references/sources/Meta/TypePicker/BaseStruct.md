...
summary: "指定FInstancedStruct属性选项列表选择的结构都必须继承于BaseStruct指向的结构"
usage: "UPROPERTY"
---
...
- **Use when:** `BaseStruct` metadata 的 `UPROPERTY` 场景需要：指定FInstancedStruct属性选项列表选择的结构都必须继承于BaseStruct指向的结构。
