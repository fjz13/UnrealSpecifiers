---
title: "GetDisallowedClasses"
id: "meta.GetDisallowedClasses"
kind: "meta"
...
summary: "用在类选择器上，通过一个函数来指定选择的类型列表中排除掉某一些类型基类"
usage: "UPROPERTY"
---
...
- **Use when:** `GetDisallowedClasses` metadata 的 `UPROPERTY` 场景需要：用在类选择器上，通过一个函数来指定选择的类型列表中排除掉某一些类型基类。
