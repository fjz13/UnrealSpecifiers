...
id: "meta.ShowDisplayNames"
kind: "meta"
symbol: "ShowDisplayNames"
category: "TypePicker"
source_status: "verified_UE5.8"
target_ue_version: "UE5.8"
normalization_status: "normalized"
normalized_at: "2026-06-04"
summary: "在Class和Struct属性上，指定类选择器显示另外的显示名称而不是类原始的名字"
usage: "UPROPERTY"
---
...
- **Use when:** `ShowDisplayNames` metadata 的 `UPROPERTY` 场景需要：在Class和Struct属性上，指定类选择器显示另外的显示名称而不是类原始的名字。
