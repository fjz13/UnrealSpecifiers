---
title: "ModuleRelativePath"
id: "meta.ModuleRelativePath"
kind: "meta"
...
summary: "记录类型定义的的头文件路径，为其处于模块的内部相对路径"
usage: "Any"
---
...
- **Use when:** `ModuleRelativePath` metadata 的 `Any` 场景需要：记录类型定义的的头文件路径，为其处于模块的内部相对路径。
