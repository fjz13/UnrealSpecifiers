---
title: "BindWidgetOptional"
id: "meta.BindWidgetOptional"
kind: "meta"
symbol: "BindWidgetOptional"
category: "Widget"
...
- **Use when:** `BindWidgetOptional` metadata 的 `UPROPERTY` 场景需要：指定在C++类中该Widget属性可以绑定到UMG的某个同名控件，也可以不绑定。
