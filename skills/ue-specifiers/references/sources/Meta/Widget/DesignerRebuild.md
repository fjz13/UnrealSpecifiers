---
title: "DesignerRebuild"
id: "meta.DesignerRebuild"
kind: "meta"
...
summary: "指定Widget里的某个属性值改变后应该重新刷新UMG的预览界面"
usage: "UPROPERTY"
---
...
- **Use when:** `DesignerRebuild` metadata 的 `UPROPERTY` 场景需要：指定Widget里的某个属性值改变后应该重新刷新UMG的预览界面。
