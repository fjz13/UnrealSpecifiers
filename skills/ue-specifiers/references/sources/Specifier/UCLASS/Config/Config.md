...
summary: "指定配置文件的名字，把该对象的值保存到ini配置文件中"
usage: "UCLASS / Config"
---
...
- **关联项：** [PerObjectConfig](PerObjectConfig.md)、[ConfigDoNotCheckDefaults](ConfigDoNotCheckDefaults.md)、[DefaultConfig](DefaultConfig.md)、[GlobalUserConfig](GlobalUserConfig.md)、[ProjectUserConfig](ProjectUserConfig.md)
- **常用程度：★★★★★**
