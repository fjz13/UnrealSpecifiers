---
title: "ConfigDoNotCheckDefaults"
id: "UCLASS.ConfigDoNotCheckDefaults"
kind: "specifier"
...
summary: "指定在保存配置值的时候忽略上一级的配置值的一致性检查"
usage: "UCLASS / Config"
---
...
- **Use when:** `ConfigDoNotCheckDefaults` specifier 的 `UCLASS / Config` 场景需要：指定在保存配置值的时候忽略上一级的配置值的一致性检查。
