...
- **Use when:** `Deprecated` specifier 的 `UCLASS / Development` 场景需要：标明该类已经弃用。
...
- **引擎模块：** Development
- **元数据类型：** bool
- **作用机制：** 在ClassFlags添加CLASS_Deprecated、CLASS_NotPlaceable，在Meta添加[DeprecationMessage](../../../Meta/Development/DeprecationMessage.md)、[DeprecatedProperty](../../../Meta/Development/DeprecatedProperty.md)
- **常用程度：★★★**
