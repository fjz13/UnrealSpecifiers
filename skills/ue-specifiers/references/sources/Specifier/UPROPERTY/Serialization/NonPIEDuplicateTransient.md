...
id: "UPROPERTY.NonPIEDuplicateTransient"
kind: "specifier"
...
summary: "在对象复制的时候，且在不是PIE的场合，忽略该属性"
...
- **Use when:** `NonPIEDuplicateTransient` specifier 的 `UPROPERTY / Serialization` 场景需要：在对象复制的时候，且在不是PIE的场合，忽略该属性。
