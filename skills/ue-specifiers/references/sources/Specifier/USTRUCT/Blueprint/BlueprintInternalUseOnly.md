...
id: "USTRUCT.BlueprintInternalUseOnly"
kind: "specifier"
...
summary: "不可定义新BP变量，但可作为别的类的成员变量暴露和变量传递"
...
- **Use when:** `BlueprintInternalUseOnly` specifier 的 `USTRUCT / Blueprint` 场景需要：不可定义新BP变量，但可作为别的类的成员变量暴露和变量传递。
