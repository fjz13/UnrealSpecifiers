---
title: "IsAlwaysAccessible"
id: "USTRUCT.IsAlwaysAccessible"
kind: "specifier"
symbol: "IsAlwaysAccessible"
scope: "USTRUCT"
category: "UHT"
...
summary: "指定UHT在生成文件的时候总是可以访问到改结构的声明，否则要在gen.cpp里生成镜像结构定义"
usage: "USTRUCT / UHT"
---
...
- **Use when:** `IsAlwaysAccessible` specifier 的 `USTRUCT / UHT` 场景需要：指定UHT在生成文件的时候总是可以访问到改结构的声明，否则要在gen.cpp里生成镜像结构定义。
